#ifndef TWISTSTAMPED_VISUAL_H
#define TWISTSTAMPED_VISUAL_H
...
namespace rviz
{
// Each instance of TwistStampedVisual represents the visualization of a single
// sensor_msgs::TwistStamped message.  Currently it just shows an arrow with
...
public:
  ...
  // which doesn't seem as clean.  This way TwistStampedVisual is only
  // responsible for visualization.
  void setFramePosition(const Ogre::Vector3& position);
  void setFrameOrientation(const Ogre::Quaternion& orientation);

  // Set the color and alpha of the visual, which are user-editable
  // parameters and therefore don't come from the TwistStamped message.
...
private:
  // The object implementing the twistStamped circle
  ...
  // the TwistStamped message header.
